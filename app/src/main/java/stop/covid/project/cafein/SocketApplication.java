...
{
    private static volatile SocketApplication instance = null;
        ...
        public IApplicationConfig getApplicationConfig() {
            return new IApplicationConfig() {
                ...
                public Context getApplicationContext() {
                    return SocketApplication.getGlobalApplicationContext();
                }
            };
        }
    }

    public static SocketApplication getGlobalApplicationContext() {
        if(instance == null) {
